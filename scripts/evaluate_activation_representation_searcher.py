...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate a dataset-specific answer-representation searcher checkpoint.")
...
def evaluate_checkpoint(
    *,
    ...
    summary: dict[str, Any] = {
        "schema_version": "activation_rag.answer_representation_searcher_eval.v1",
